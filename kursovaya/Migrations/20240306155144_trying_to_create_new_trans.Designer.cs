...
namespace rlf.Migrations
{
    ...
    [Migration("20240306155144_trying_to_create_new_trans")]
    partial class trying_to_create_new_trans
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("rlf.Data.Models.Transaction", b =>
                {
                    b.HasOne("rlf.Data.Models.Category", null)
                        .WithMany("Transactions")
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("rlf.Data.Models.User", null)
                        .WithMany("Transactions")
